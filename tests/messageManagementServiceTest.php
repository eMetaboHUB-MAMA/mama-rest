 ...
 *        
 */
class MessagesManagementServiceTest extends PHPUnit_Framework_TestCase {
	...
	public function testCreated() {
		...
		$this->assertEquals ( $user->getId (), $newMessage->getFromUser ()->getId (), "[error] 'create' or 'get' (by id) does not work" );
		$this->assertEquals ( $newProject->getId (), $newMessage->getToProject ()->getId (), "[error] 'create' or 'get' (by id) does not work" );
