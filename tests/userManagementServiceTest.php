...
class UserManagementServiceTest extends PHPUnit\Framework\TestCase
{
	...
	public function testUpdate()
	{
		...
		// test FAIL
		$success1 = UserManagementService::update(-1, "nopTesta UPDATE", "junit UPDATE", "test UPDATE", 33, "98 76 54 32 10", "labo of unit tests UPDATE", "office truc street much UPDATE", "private", "daily_digest", true, true, true, true, null);
		$this->assertEquals(false, $success1, "[error] 'create' or 'get' (by id) do not work");

		// test SUCCESS
		$success2 = UserManagementService::update($id, null, "junit UPDATE", "test UPDATE", 33, "98 76 54 32 10", "labo of unit tests UPDATE", "office truc street much UPDATE", "private", "daily_digest", true, true, true, true, null);
		...
		$success3 = UserManagementService::update($id, "super coin-coin, i'm gr00t", "junit UPDATE", "test UPDATE", 33, "98 76 54 32 10", "labo of unit tests UPDATE", "office truc street much UPDATE", "private", "daily_digest", true, true, true, true, null);
