...
class ProjectExtraDataManagementServiceTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testCreated()
    {
        ...
        // create user
        $email = "junit.test.create." . microtime() . "@inra.fr";
    ...
    // // create
    // $email = "junit.test.updateObj." . microtime() . "@inra.fr";
    ...
    // // create
    // $email = "junit.test.delete." . microtime () . "@inra.fr";
    // $id = UserManagementService::create ( $email, $email, "nopTesta", "junit", "test", 44, "01 23 45 67 89", "labo of unit tests", "office truc street much", "public" );
    ...
    // // create
    // $email = "junit.test.find." . microtime () . "@inra.fr";
    // $id = UserManagementService::create ( $email, $email, "nopTesta", "junit", "test", 44, "01 23 45 67 89", "labo of unit tests", "office truc street much", "public" );
