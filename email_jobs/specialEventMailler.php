...
class SpecialEventMailler {
	 ...
	 */
	public static function sendEmailNewMessage($message, $project) { // OrAppointment $appointment
		$users = array ();
		// Project
		if (! is_null ( $project )) {
			$owner = $project->getOwner ();
	...
	/**
	 */
	public static function sendEmailNewAppointment($appointment, $project) { // OrAppointment $appointment
		$users = array ();
		// Project
		if (! is_null ( $project )) {
			$owner = $project->getOwner ();
	...
	/**
	 */
	public static function sendEmailUpdateAppointment($appointment, $project, $isSuccess = null, $appDate = null) { // OrAppointment $appointment
