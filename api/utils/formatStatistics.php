...
function buildUsersStatsSheet($objPHPExcel)
{
	...
	// TABLE 2: headers
	$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue('A10', 'active users');
	//
	$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue('A11', '#id');
	$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue('B11', 'full name');
	$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue('C11', 'email');
	$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue('D11', 'last activity');
	$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue('E11', 'right(s)');
	$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue('F11', 'status');
	...
	foreach ($users as $key => $value) {
		$t = 0;
		$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue($magicAlphabet[$t++] . $i, $value->getId());
		$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue($magicAlphabet[$t++] . $i, $value->getFullName());
		$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue($magicAlphabet[$t++] . $i, $value->getEmail());
		$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue($magicAlphabet[$t++] . $i, $value->getLastActivity());
		$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue($magicAlphabet[$t++] . $i, $value->getRight());
		$objPHPExcel->setActiveSheetIndex($currentSheet)->setCellValue($magicAlphabet[$t++] . $i, $value->getStatus());
		$i++;
	}

	// formatting
	$objPHPExcel->setActiveSheetIndex($currentSheet);
	$objPHPExcel->getActiveSheet()->getStyle('A10:A10')->getFont()->setBold(true);
