...
class UserManagementService {
	 ...
	 */
	public static function update($id, $password, $firstName, $lastName, 
			/**/
			$phoneGroup, $phoneNumber, $laboratoryOrCompagny, $workplaceAddress, $typeOfLaboratoryOrCompany,
			/**/
			$emailReception, $emailAlertNewUserAccount, $emailAlertNewProject, $emailAlertNewEventFollowedProject, $emailAlertNewMessage, $emailLanguage = "en", $userSource = null) {
